...
const navigation = [
  ...
  { name: "My Buyers", href: "/buyers", icon: Users },
  { name: "Earnings Report", href: "/earnings", icon: DollarSign },
  { name: "Onboard Buyer", href: "/onboard", icon: UserPlus },
];
...
export default function BrokerLayout({ user, onLogout }: BrokerLayoutProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg border-r border-gray-200">
        ...
        <div className="flex h-16 items-center justify-center border-b border-gray-200 px-6">
          ...
          />
          <span className="ml-3 text-xl font-bold text-gray-900">Broker Portal</span>
        </div>
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">{user.name}</p>
                <p className="text-xs text-gray-500">Sales Broker</p>
              </div>
              <button 
                onClick={onLogout}
